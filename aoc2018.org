...
:END:
** Why Clojure?
I've been attracted to functional programming from the moment I became aware of the idea. This attraction may be afiliated with my love for Lisp. This story has yet to be told but my adventure with coding started with Emacs[fn::I have liberal arts background -- looking for a tool to manage "multidimensional" notes was the link], that is with Elisp langwise, and, as we put it in Polish, "first love does not rust" (old love never dies), nor does my inclination to Lisp(y)s.
